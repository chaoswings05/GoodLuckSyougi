...
public class MapManager : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0) && playerSelected == false)
        {
            ...
            Vector2 clickPosition = Camera.main.ScreenToWorldPoint(Input.mousePosition);//ÇªÇÃÇ‹Ç‹Ç‚ÇÈÇ∆Ç§Ç‹Ç≠Ç¢Ç©Ç»Ç¢ÇÃÇ≈Camera.main.ScreenToWorldPointÇ≈ç¿ïWå`éÆÇïœä∑Ç∑ÇÈÅB
